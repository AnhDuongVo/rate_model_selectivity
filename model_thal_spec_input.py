...
listinput = np.load('data/visual_input_thal.npy',allow_pickle=True)

Parallel(n_jobs=p.jobs_number)(delayed(run_simulation)(input_cs_steady, input_cc_steady, input_pv_steady,input_sst_steady,
                                                       input_cs_amplitude, input_cc_amplitude,input_pv_amplitude, input_sst_amplitude,
                                                       weight_scalar, weight_choice,
                                                       spatialF, temporalF,spatialPhase,
                                                       thal_degree,thal_scalars,start_time,title)
                    for [input_cs_amplitude,input_cc_amplitude, input_pv_amplitude, input_sst_amplitude, thal_degree,thal_scalars] in listinput
